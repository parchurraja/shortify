...
import { Link2, Eye, EyeOff, Lock, Mail, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4 relative overflow-hidden font-sans selection:bg-indigo-500 selection:text-white">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-white font-outfit">Welcome back</h1>
          <p className="text-slate-400 mt-2 text-sm">Sign in to your Shortify account to manage your links</p>
        </div>
